                ...
                <ul className="flex-column">
                    <li className="nav-item">
                        <div className="element-column">
                            ...
                            <a className="nav-link pl-0 text-light" href="/homepage"> Acceuil</a>
                        </div>
                        <div className="element-column">
                            ...
                            <a className="nav-link pl-0 text-light" href="#"> Explorer</a>
                        </div>
                        <div className="element-column">
                            ...
                            <a className="nav-link pl-0 text-light" href="#"> Notifications</a>
                        </div>
                        <div className="element-column">
                            ...
                            <a className="nav-link pl-0 text-light" href="#"> Messages</a>
                        </div>
                        <div className="element-column">
                            ...
                            <a className="nav-link pl-0 text-light" href="#"> Signets</a>
                        </div>
                        <div className="element-column">
                            ...
                            <a className="nav-link pl-0 text-light" href="#"> Listes</a>
                        </div>
                        <div className="element-column">
                            ...
                            <a className="nav-link pl-0 text-light" href="/profil"> Profil</a>
                        </div>
                        <div className="element-column">
                        <svg viewBox="0 0 24 24" aria-hidden="true"><g><circle cx="17" cy="12" r="1.5"></circle><circle cx="12" cy="12" r="1.5"></circle><circle cx="7" cy="12" r="1.5"></circle><path d="M12 22.75C6.072 22.75 1.25 17.928 1.25 12S6.072 1.25 12 1.25 22.75 6.072 22.75 12 17.928 22.75 12 22.75zm0-20C6.9 2.75 2.75 6.9 2.75 12S6.9 21.25 12 21.25s9.25-4.15 9.25-9.25S17.1 2.75 12 2.75z"></path></g></svg>
